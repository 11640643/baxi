...
//    }
    ...
    public function infoAction()
    {
        ...
        $weekArray = ["Dia", "One", "Two", "Three", "Four", "Five", "Six"];
        $aprTime = $this->s_il->getNextAprTime($item['type'], $item['days']);
        $aprDate = date('d-m-Y', $aprTime) . '（semana' . $weekArray[date('w', $aprTime)] . '）';
        ...
        $data = [
            ...
            'remark' => "Agende agora , {$aprDate} criar renda, bloquear {$item['days']} dias sem poder transferir durante este período"
        ];
    ...
    public function contractAction()
    {
        ...
        $data = [
            ...
            'contract_date' => date('d-m-Y', $il['addtime']),
